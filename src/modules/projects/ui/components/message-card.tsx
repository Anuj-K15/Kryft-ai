    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col flex-1">
                <span className="text-sm font-medium line-clamp-1">{fragment.title}    
                </span>
    ...
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-2 pl-2 mb-2">
                ...
                <span className="text-xs font-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity">
